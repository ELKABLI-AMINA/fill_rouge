...
<div class="container mt-5" >
  ...
  <div class="row">
    <div class="col-md-6">
      <h3 class="h3 mb-3 text-success ">« BACKSEAT SURFING Travel est une agence de voyage opérant dans le tourisme et ayant pour spécialité l’organisation des voyages à l’échelle nationale .</h3>
      ...
      <h3 class="h3 mb-3 text-success ">« Nos engagements vers vos »</h3>
      <ul>
    ...
    <div class="col-md-6">
      <h3 class="h3 mb-3 text-success ">« C’est notre spécialité … laissez-vous aller dans la musique des sons humains et bercer par sa diversité »</h3>
      ...
      <h3 class="h3 mb-3 text-success ">« Votre service est notre honneur »</h3>
      <ul>
