                ...
                <div class="row align-items-center">
                    ...
                    <form method="POST" action="{{ route('update-profile') }}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="name" value="{{ old('name', Auth::user()->name) }}" id="name" class="form-control"  required autofocus>
                      </div>
          
                      <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" name="email" value="{{ old('name', Auth::user()->Email) }}" id="email" class="form-control"  required>
                      </div>

                      <div class="form-group">
                        <label for="phone_number">Phone_Number</label>
                        <input type="tel" name="phone_number" value="{{ old('name', Auth::user()->phone_number) }}" id="phone_number" class="form-control"  required>
                      </div>
