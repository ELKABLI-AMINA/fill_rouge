            ...
            <div class="text-container d-flex align-items-center justify-content-between ">
                <div class="text-content d-flex justify-content-center">
                    <p class="para-text "> <span class="span_text"> <i
                                class="fa-solid fa-envelope"></i></span>Example@gmail.com</p>
                    <p class="para-text "> <span class="span_text"> <i class="fa-solid fa-phone"></i></span>0522222222
                    </p>
                </div>
                <div class="social-links">
                    ...
                    <i class="fa-brands icon-social fa-linkedin-in"></i>
                </div>
                <div class="navbar-container">
                    <nav class="navbar navbar-expand-lg ">
                        <a class="navbar-brand" href="#">
                            <h3 class="heading-logo">BLA<span class="text-success">DI.</span></h3>
                        </a>
